...
export const MiskTabVersions: IMiskTabVersions = {
  [MiskVersion.v015_9]: {
    [MiskPkg.cli]: `${[MiskVersion.v015_9]}`,
    [MiskPkg.common]: `${[MiskVersion.v015_9]}`,
    [MiskPkg.core]: `${[MiskVersion.v015_9]}`,
    [MiskPkg.dev]: `${[MiskVersion.v015_9]}`,
    [MiskPkg.simpleredux]: `${[MiskVersion.v015_9]}`,
    [MiskPkg.tslint]: `${[MiskVersion.v015_9]}`,
    date: "2019-02-28",
